...
lines= pd.read_table('flaskblog/model/kan.txt', names=['correct', 'wrong'],delimiter='~')
lines.shape
# Remove quotes
...
with open('flaskblog/model/Weights/X_train.pkl', 'rb') as f:
    X_train = pickle.load(f)
with open('flaskblog/model/Weights/X_test.pkl', 'rb') as f:
    X_test = pickle.load(f)
with open('flaskblog/model/Weights/y_train.pkl', 'rb') as f:
    y_train = pickle.load(f)
with open('flaskblog/model/Weights/y_test.pkl', 'rb') as f:
...
def func(text):
    model.load_weights('flaskblog/model/kannadamodel_weights.h5')
